<%-- 
    ...
    Created on : Feb 14, 2021, 8:06:30 PM
    Author     : tanta
--%>
    ...
    <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
        ...
        <header class="masthead bg-primary text-white text-center mt-5">
            <div class="container d-flex align-items-center flex-column">
                ...
                <!-- Masthead Heading-->
                <h1 class="masthead-heading text-uppercase mb-0">Welcome to quiz online</h1>
                <!-- Icon Divider-->
                ...
                <!-- Masthead Subheading-->
                <p class="masthead-subheading font-weight-light mb-5">Graphic Artist - Web Designer - Illustrator</p>
        ...
        <!-- Copyright Section-->
        <div class="copyright py-5 text-center text-white footer fixed-bottom">
