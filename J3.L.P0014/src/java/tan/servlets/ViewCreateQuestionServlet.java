...
public class ViewCreateQuestionServlet extends HttpServlet {

    private static final String ERROR = "error.jsp";
    private static final String SUCCESS = "create.jsp";
    final static Logger LOGGER = Logger.getLogger(ViewCreateQuestionServlet.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            LOGGER.error("Error at ViewCreateQuestionServlet : " + e.getMessage());
        } finally {
